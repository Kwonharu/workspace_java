...
public class PostgreSQLDAOImpl implements UserInfoDAO{
	...
	public void insertUserInfo(UserInfoDTO userInfoDTO) {
		System.out.println("insert into PostgreSQL BD userId : "+userInfoDTO.getUserId());
		
	}

	@Override
	public void updateUserInfo(UserInfoDTO userInfoDTO) {
		System.out.println("update into PostgreSQL BD userId : "+userInfoDTO.getUserId());
		
	}

	@Override
	public void deleteUserInfo(UserInfoDTO userInfoDTO) {
		System.out.println("delete into PostgreSQL BD userId : "+userInfoDTO.getUserId());
		
	}

	@Override
	public void selectUserInfo(UserInfoDTO userInfoDTO) {
		System.out.println("select into PostgreSQL BD userId : "+userInfoDTO.getUserId());
